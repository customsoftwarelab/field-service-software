...
if($b["assignedtech"] != 'none'){
	

$ut =mysql_fetch_array(mysql_query("SELECT * FROM core_users WHERE usr_id = '".$b["assignedtech"]."' AND saasid = '".$_SESSION['saasid']."'"));
$tech = $ut["fname"].' '.$ut["lname"];
}else{
	$tech = 'No tech assigned';
}
...
<span style="font-weight:bold;">Cost:</span> $'.$b["value"].'<br><span style="font-weight:bold;">Type:</span> '.$b["base_type"].'<br>
<span style="font-weight:bold;">Due Date:</span> '.$b["duedate"].'<br>
<span style="font-weight:bold;">Service Date:</span> '.$b["servicedate"].'<br>
<span style="font-weight:bold;">Duration:</span> '.$b["duration"].'hrs<br>
<span style="font-weight:bold;">Priority:</span> '.$b["priority"].'<br>
<span style="font-weight:bold;">Recurring:</span> '.$rec.'<br>
<span style="font-weight:bold;">Technician:</span> '.$tech.'<br>
<span style="font-weight:bold;">PO#:</span> '.$po.'<br><br><br><span style="font-weight:bold;">Contact Info:</span><br>
 '.$h["firstname"].' '.$h["lastname"].' | '.$h["title"].'<br>em. '.$h["email"].'<br>ph. '.$h["phone"].'<br>
