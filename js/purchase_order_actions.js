$(function() {
		...
		$.ajax({
  url: 'inc/purchase_order_actions.php?action=getlist',
...
function recallEstis(){
  ...
  success: function(data) {
	...
	$.ajax({
  url: 'inc/purchase_order_actions.php?action=getstatdrop&setval='+val+'&sentid='+val2,
  success: function(data) {
	...
	function addProdiserv(){
		...
		if(comp != 'none'){var er1 = '';}else{var er1 = 'Select Vendor<br>';}

		
		
		if(er1 == ''){
		$.ajax({
  url: 'inc/purchase_order_actions.php?action=getproservlist',
  success: function(data) {
    $('#estiadd').html(data);
	...
	function getEstform(){
		$.ajax({
  url: 'inc/purchase_order_actions.php?action=getaddest',
  success: function(data) {
    $('#esti_content').html(data);
	
	$(".make").uniform();
	
	$( "#credate, #duedate" ).datepicker({
				showOn: "button",
					buttonImage: "images/date_ico.png",
				buttonImageOnly: true,
				changeMonth: true,
	...
	function runCons(val){
		...
		$.ajax({
  url: 'inc/purchase_order_actions.php?action=getcons&compid='+val,
  success: function(data) {
    $('#estconssd').html(data);
	...
	function runLocs(val){
		//alert(val);
		$.ajax({
  url: 'inc/purchase_order_actions.php?action=getlocs&compid='+val,
  success: function(data) {
    $('#estlocss').html(data);
	...
	function getTaxs(val){
		...
		$.ajax({
  url: 'inc/purchase_order_actions.php?action=gettaxs&compid='+val,
  success: function(data) {
    $('#taxcont').html(data);
	...
	var productservi = $("#productservi").val();
		...
		$.ajax({
  url: 'inc/purchase_order_actions.php?action=additem&itemid='+producuid+'&quant='+quant+'&docid='+docid+'&istax='+tax+'&proservprice='+proservprice,
  success: function(data) {
  $("#estiadd").dialog( "close" );
	...
	function getItemlist(){
		...
		var estloc = $("#estloc").val();
		$.ajax({
  url: 'inc/purchase_order_actions.php?action=getitmelist&doc_id='+doc_id+'&locid='+estloc,
  success: function(data) {
   $("#itmhold").html(data);
	}
  });	
	...
	function goTotal(){
		...
		var estloc = $("#estloc").val();
	$.ajax({
  url: 'inc/purchase_order_actions.php?action=grbmoney&docid='+doc_id+'&locid='+estloc,
  success: function(data) {
  $("#tothold").html(data);
  }
  });		
	...
	var comp = $("#comp").val();
		...
		if(er1 == ''){
			...
			$.ajax({
  url: 'inc/purchase_order_actions.php?action=insertestimate&docid='+doc_id+'&comp='+comp+'&type='+type+'&credate='+credate+'&duedate='+duedate+'&notes='+notes+'&estiamount='+estiamount+'&status='+status,
  success: function(data) {
  recallEstis();
  $("#confrmsucc").fadeIn('slow');
	...
	function geteditEstform(val){
		$.ajax({
  url: 'inc/purchase_order_actions.php?action=editest&docid='+val,
  success: function(data) {
    $('#esti_content').html(data);
	...
	var comp = $("#comp").val();
		...
		if(comp != 'none'){er1 = '';}else{er1 = 'Select Vendor<br>';}
		
		if(er1 == ''){
			
			$.ajax({
  url: 'inc/purchase_order_actions.php?action=editestimate&docid='+doc_id+'&comp='+comp+'&type='+type+'&credate='+credate+'&duedate='+duedate+'&notes='+notes+'&estiamount='+estiamount+'&status='+status,
  success: function(data) {
  recallEstis();
  $("#confrmsucc").fadeIn('slow');
	  ...
	  setTimeout(function(){ $("#confrmsucc").fadeOut('slow') }, 5000);
			...
			$("#alerts").html('<strong style="color:#1053A3;">An error has occurred!</strong><br><span style="font-size:12px;"><br><br>'+er1+' '+er2+' '+er3+' '+er5);
		 ...
		 $("#alerts").html('<strong style="color:#1053A3;">Are you sure you wish to delete this item?</strong><br>');
			...
			buttons: {
				...
				'Yes': function() {
					...
					$.ajax({
  url: 'inc/purchase_order_actions.php?action=delitem&itmid='+val,
  success: function(data) {
 getItemlist();
 $("#confrmsucc").fadeIn('slow');
	...
	function upqut(val){
		$.ajax({
  url: 'inc/purchase_order_actions.php?action=pullqtfld&itmid='+val,
  success: function(data) {
 ...
 $("#updtqt"+val).focus();
	...
	function editItm(val){
		...
		$.ajax({
  url: 'inc/purchase_order_actions.php?action=updtqty&itmid='+val+'&newvalue='+newqut,
  success: function(data) {
getItemlist();
$("#confrmsucc").fadeIn('slow');
			...
			buttons: {
				...
				'Yes': function() {
					$( this ).dialog( "close" );
						...
						$.ajax({
  url: 'inc/purchase_order_actions.php?action=delesti&docid='+val,
  success: function(data) {
recallEstis();
$("#confrmsucc").fadeIn('slow');
			...
			buttons: {
				...
				'Yes': function() {
					$( this ).dialog( "close" );
						...
						$.ajax({
  url: 'inc/purchase_order_actions.php?action=changelinestat&docid='+val+'&statu='+val2,
  success: function(data) {
recallEstis();
$("#confrmsucc").fadeIn('slow');
...
$(function() {
   ...
   $.ajax({
  url: 'inc/purchase_order_actions.php?action=ramitems',
  success: function(data) {
  }
  });
